...
namespace CommandTerminal
{
    ...
    public class Terminal : MonoBehaviour
    {
        ...
        public static Action TerminalClosing;
        public static Action TerminalOpening;
        ...
        public void SetState(TerminalState new_state) {
            ...
            {
                TerminalClosing?.Invoke();
            }
            else if (state == TerminalState.OpenSmall)
            {
                TerminalOpening?.Invoke();
            }
        }
